...
class ResEmoNet:
    """
    Loads ResNet-based model (ResEmoNet) pre-trained on AffectNet for emotion recognition.
    """
    def __init__(self, model_path="models/resemotenet_affectnet.pth", device="cpu"):
        self.device = torch.device(device)

        # Load pre-trained ResNet model
        self.model = models.resnet18(pretrained=False)  # Using ResNet-18 as base
        self.model.fc = nn.Linear(self.model.fc.in_features, 8)  # AffectNet has 8 emotions
